    ...
    return (
        <section className="bg-grey-75 h-full flex relative">
            <div className="flex flex-col md:flex-row items-center justify-center h-full w-full md:w-1/2">
                ...
                <div className="w-full max-w-[550px] md:justify-end 3xl:max-w-[650px] text-grey-900 text-center md:text-left space-y-6 md:space-y-[38px] px-7 md:px-10 pt-20 md:pt-[160px] 3xl:pt-[218px] pb-10 md:pb-[200px] 3xl:pb-[302px]">
                ...
                <div className="w-full order-1 h-[345px] sm:h-[480px] md:h-full md:w-1/2 md:absolute right-0 top-0">
                    <Image
                        src="/images/electric.jpg"
                        alt="Muvment electric vehicles"
                        width={884}
                        height={910}
